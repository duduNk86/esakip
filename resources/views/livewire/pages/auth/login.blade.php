...
new #[Layout('layouts.guest')] class extends Component {
    ...
    {
        $this->captchaText = substr(str_shuffle('ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnpqrstuvwqyz123456789'), 0, 6);
        ...
        {{-- <form wire:submit="login" class="login-form"> --}}
                ...
                <div class="mt-4">
                    ...
                    <div class="captcha-form flex">
                        ...
                        <button type="button" wire:click="generateCaptcha"
                            class="bg-gray-500 text-white px-3 rounded-r">
            ...
            <footer class="py-2 mt-5 text-center text-xs text-black dark:text-black/70">
                ...
                | PENAKs`E <a href="https://inspektorat.wonosobokab.go.id" target="_blank"
                    class="text-blue-600 hover:underline">Inspektorat Daerah Kab.
