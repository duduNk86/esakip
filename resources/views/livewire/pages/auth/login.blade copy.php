    ...
    <div>
        <footer class="py-2 mt-5 text-center text-xs text-black dark:text-black/70">
            ...
            @if (now()->year != 2025)
                - {{ now()->year }}
            @endif
            | e-SAKIP <a href="https://website.wonosobokab.go.id" target="_blank">Inspektorat Daerah Kabupaten
                Wonosobo</a><br>Powered by <a href="https://diskominfo.wonosobokab.go.id/"
                target="_blank">Diskominfo</a> |
            Mas@guNk86
        </footer>
    </div>
</div>
