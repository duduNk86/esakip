                ...
                @if (auth()->user()?->role === 'superadmin')
                    <div class="hidden space-x-8 sm:flex sm:items-center sm:ms-10">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('periode.index')" wire:navigate>
                                    <div class="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                ...
                                <div x-data="{ sakipOpen: false }" class="relative">
                                    <button @click.stop="sakipOpen = !sakipOpen"
                                        class="flex items-center w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 space-x-2"
                                        type="button">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <path
                                        ...
                                        <svg class="w-4 h-4 ml-auto transform transition-transform duration-200"
                                            :class="{ 'rotate-90': sakipOpen }" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                    ...
                                    <!-- Submenu -->
                                    <div x-show="sakipOpen" x-transition @click.away="sakipOpen = false"
                                        class="absolute left-full top-0 ml-0 mt-0 w-48 bg-white border border-gray-200 shadow-lg rounded-md z-50">
                                        ...
                                        <a href="{{ route('komponen.index') }}"
                                            ...
                                            <span>{{ __('Komponen') }}</span>
                                        </a>
                                        <a href="{{ route('subkomponen.index') }}"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 space-x-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700"
                                                viewBox="0 0 24 24" fill="currentColor">
                                                <path fill-rule="evenodd"
                                ...
                                <x-dropdown-link :href="route('opd.index')" wire:navigate>
                                    <div class="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <path fill-rule="evenodd"
                                ...
                                <x-dropdown-link :href="route('appsetup.index')" wire:navigate>
                                    <div class="flex items-center space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-700"
                                            viewBox="0 0 24 24" fill="currentColor">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            Hi, &nbsp;<div x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name"
